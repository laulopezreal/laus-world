...
3. Team to raise:
	1. Registration in Service Now (Application Service or Bussiness Application as corresponds)
	2. RID (Risk Impact Determination)
	3. PIA (Privacy Impact Assessment)
	4. AZ AI Governance Maturity Assessment - only if apply (https://az.brightidea.com/AIGovernanceMaturityAssessment)
	5. 
4. Architect to raise Cyber Security Assessment

#Process #KnowledgeArticle #AZ