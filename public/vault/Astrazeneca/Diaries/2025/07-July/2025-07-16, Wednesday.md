...
- [ ] Prepare a report with implicationsx of 6.1 for the solution blueprint
...
- [ ] Follow up with Carolina on resolution
- [x] Follow up with Michael and Emma on resolution
- [x] Update Haji about current situation
- [x] Send financial form to self service
- [x] Send fee status reassessment to self service
- [x] Answer Namshik
